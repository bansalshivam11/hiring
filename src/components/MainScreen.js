            ...
            <div className="grid-container">
                ...
                <div className="form-container">
                    <div className="main-content">
                        <Routes>
                            <Route path="/dashboard" element={<Dashboard formDataObject={formDataObject} />} />
                            <Route path="/job-req" element={<JobReq onFormDataSubmit={onFormDataSubmit} />} />
                            <Route path="/jobreq/:requisition_id" element={<JobReqDetail />} />
                            <Route path="/approvals/:requisition_id" element={<Approvals />} />
                            <Route path="/approvals" element={<Approvals />} />
                            <Route path="/cvscreening" element={<CV_Screening />} />
                            <Route path="/profilepost" element={<Profile_Post />} />
                            <Route path="/candidates" element={<CandidateScreening formDataObject={formDataObject} />} />
